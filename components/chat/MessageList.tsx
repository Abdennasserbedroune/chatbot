  ...
  return (
    ...
    >
      ...
      {messages.length === 0 && !isTyping && (
        ...
        >
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-2xl font-medium shadow-lg mb-4">
            AI
          </div>
